...
public class BatalhaNaval {
    public static void main(String[] args) throws Exception {
        ...
        char[][] tabuleiroExibicao = new char[8][8];
        ...
        // Mostra o mapa atual para o usuario enquanto ele nao acertou tudo
        int acertos = 0;
        while (acertos < 10) {
            System.out.println("Mapa atual: ");
            for (int i = 0; i < 8; i++) {
                for (int j = 0; j < 8; j++) {
                    System.out.print(tabuleiroExibicao[i][j] + " ");
                }
                System.out.println();
            }
        }
        ...
        do {
            ...
            System.out.println("Digite as coordenadas para atacar: ");
            ...
            if (tabuleiro[linha][coluna] == 'N') {
                ...
                tabuleiroExibicao[linha][coluna] = 'A';
                acertos++;
                tentativas--;
            } else {
                System.out.println("Errou! Não há nada nessa posição");
                tabuleiroExibicao[linha][coluna] = 'X';
                tentativas--;
            }
        ...
        for (int j = 0; j < 8; j++) {
            for (int l = 0; l < 8; l++) {
                System.out.print(tabuleiroExibicao[j][l] + " ");
            }
            System.out.println();
        }
    }
